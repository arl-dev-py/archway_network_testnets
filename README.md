...
Configurations and instructions for connecting to **testnet** networks Archway Network (Cosmos SDK).
...
2. Download genesis + node config
# Main testnet
...
git clone [https://github.com/arl-dev-py/archway-network-testnets.git](https://github.com/arl-dev-py/archway-network-testnets.git)
cd archway-network-testnets
...
curl -sSfL [https://raw.githubusercontent.com/archway-network/mainnet/main/install.sh](https://raw.githubusercontent.com/archway-network/mainnet/main/install.sh) | bash
